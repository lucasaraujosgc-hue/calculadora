...
import { LayoutDashboard, Calculator, Box, Tags, DollarSign, Wallet, FileText, Settings, LogOut, FileSpreadsheet, Percent, Users, TrendingUp, Layers, Menu, X, ChevronLeft, ChevronRight, Star } from 'lucide-react';
